<template>
  <footer class="full" >
    ...
    <div class="content-container align-center space-between">
      ...
      <div class="info-container flex">
        <div class="loc-info flex  justify-content">
          ...
          <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Qui eius eos, assumenda provident similique porro!</p>
        </div>

        <div class="conection-info flex">
          <div class="flex">
          ...
          <div class="social-links flex">
            <span class="facebook"><img src="../assets/img/fa.png"></span>
            <span class="twitter"><img src="../assets/img/tw.png"></span>
            <span class="instagram"><img src="../assets/img/in.png"></span>
          </div>
